...
public class ResourceUtil {
    ...
    public static Drawable getDrawable(@NonNull final Context context, final int id) {
        Drawable drawable = null; // "null" by default
        ...
        if (drawable == null) {
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    drawable = context.getResources().getDrawable(id); // Deprecated
                }
            } catch (Exception e) {
                LogUtil.e(TAG, e.getMessage());
                LogUtil.e(TAG, e.toString());
        ...
        if (color == -1) {
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    color = context.getResources().getColor(id); // Deprecated
                }
            } catch (Exception e) {
                LogUtil.e(TAG, e.getMessage());
                LogUtil.e(TAG, e.toString());
    ...
    public static Typeface getFont(@NonNull final Context context, final int id) {
        Typeface font = null; // "null" by default
