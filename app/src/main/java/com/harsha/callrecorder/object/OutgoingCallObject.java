...
public class OutgoingCallObject extends RealmObject {
    ...
    public OutgoingCallObject (boolean isHeader, String headerTitle) {
        mIsHeader = isHeader;
